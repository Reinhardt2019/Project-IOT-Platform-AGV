...
(cl:in-package wheeltec_multi-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <avoid>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'avoid)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wheeltec_multi-msg:<avoid> is deprecated: use wheeltec_multi-msg:avoid instead.")))

(cl:ensure-generic-function 'angleX-val :lambda-list '(m))
(cl:defmethod angleX-val ((m <avoid>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wheeltec_multi-msg:angleX-val is deprecated.  Use wheeltec_multi-msg:angleX instead.")
  (angleX m))

(cl:ensure-generic-function 'angleY-val :lambda-list '(m))
(cl:defmethod angleY-val ((m <avoid>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wheeltec_multi-msg:angleY-val is deprecated.  Use wheeltec_multi-msg:angleY instead.")
  (angleY m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <avoid>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wheeltec_multi-msg:distance-val is deprecated.  Use wheeltec_multi-msg:distance instead.")
  (distance m))
