...
(cl:in-package delivery_navigation-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <ClientPose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ClientPose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name delivery_navigation-srv:<ClientPose-request> is deprecated: use delivery_navigation-srv:ClientPose-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <ClientPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delivery_navigation-srv:x-val is deprecated.  Use delivery_navigation-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <ClientPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delivery_navigation-srv:y-val is deprecated.  Use delivery_navigation-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <ClientPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delivery_navigation-srv:z-val is deprecated.  Use delivery_navigation-srv:z instead.")
  (z m))

(cl:ensure-generic-function 'orientation-val :lambda-list '(m))
(cl:defmethod orientation-val ((m <ClientPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delivery_navigation-srv:orientation-val is deprecated.  Use delivery_navigation-srv:orientation instead.")
  (orientation m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ClientPose-request>)))
  ...
  "delivery_navigation/ClientPoseRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ClientPose-request)))
  "Returns string type for a service object of type 'ClientPose-request"
  "delivery_navigation/ClientPoseRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ClientPose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ClientPose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name delivery_navigation-srv:<ClientPose-response> is deprecated: use delivery_navigation-srv:ClientPose-response instead.")))

(cl:ensure-generic-function 'succeed-val :lambda-list '(m))
(cl:defmethod succeed-val ((m <ClientPose-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delivery_navigation-srv:succeed-val is deprecated.  Use delivery_navigation-srv:succeed instead.")
  (succeed m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ClientPose-response>)))
  ...
  "delivery_navigation/ClientPoseResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ClientPose-response)))
  "Returns string type for a service object of type 'ClientPose-response"
  "delivery_navigation/ClientPoseResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ClientPose)))
  ...
  "delivery_navigation/ClientPose")